      ...
      <section className='chatbot-section flex flex-col origin:w-[800px] w-full origin:h-[735px] h-full rounded-md p-2 md:p-6'>
        <div className='chatbot-header pb-6'>
          <div className='flex justify-between'>
            <div className='flex items-center gap-2'>
              ...
              <h1 className='chatbot-text-primary text-xl md:text-2xl font-medium'>승현</h1>
            </div>
          ...
          */}
          <p className="chatbot-text-secondary-inverse text-sm md:text-base mt-2 md:mt-4">승현이와 대화를 시작하세요!</p>
        </div>
        ...
        <form className='flex h-[40px] gap-2' onSubmit={handleSend}>
          ...
          <button type="submit" className='chatbot-send-button flex rounded-md items-center justify-center px-2.5 origin:px-3'>
            ...
            <span className='hidden origin:block font-semibold text-sm ml-2'>보내기</span>
          </button>
        </form>
        <Footer />
      </section>
